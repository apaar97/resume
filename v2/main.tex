...
\resumeItem{Developed web and mobile application for audio conference calls with real-time accent translation.}
...
\resumeItemListStart
\resumeItem{Developed Android app to translate text conversations, supporting 90+ languages with speech-to-text and text-to-speech features for ease of accessibility. \textit{Tech used: Java, Android, XML}}
\resumeItemListEnd
