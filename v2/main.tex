...
\resumeItem{Built recommender system to map project mentors to trainee candidates.}
\resumeItem{Implemented web application and REST API layer for android client.}
\resumeItemListEnd
...
\resumeItem{\textit{Tech used: Python, Keras, Tensorflow, NLTK, Socket.io, Django, HTML, CSS, Android}}
\resumeItemListEnd
...
\resumeItem{\textit{Tech used: Google Firebase, Cisco DevNet, Node, Express, JavaScript, HTML, CSS, Android}}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Developed Android app to translate text conversations, supporting 90+ languages with speech-to-text and text-to-speech features for ease of accessibility.} \resumeItem{\textit{Tech used: Java, Android, XML, Yandex Translate}}
\resumeItemListEnd
...
\small{\item{
	...
	\textbf{Software development:}{ React, NodeJS, Express, SQL, MongoDB, Elasticsearch, Django, PyGame, Android, Git}
	\\ \vspace{3pt}
